/*
Данный скетч принимает код с брелока NICE FLOR-S и выводит принятый код на экран
*/

#define rxPin 2 //пин приемника

#include <Wire.h> //библиотека для 2 строчного экрана 
#include <LiquidCrystal_I2C.h> //библиотека для 2 строчного экрана
...
void setup() {
 ...
 lcd.setCursor(0, 0); //установка курсора на экране в 0 строку, 0 места.
 lcd.print("NICE FLOR-S: "); //вывод строки на экран
